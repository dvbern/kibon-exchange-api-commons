...
public class GesuchstellerDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder newBuilder() {
    return new ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder();
  }
   ...
   * @return A new GesuchstellerDTO RecordBuilder
   */
  public static ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder newBuilder(ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder other) {
    if (other == null) {
      return new ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder();
    } else {
      return new ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder(other);
    }
  }
   ...
   * @return A new GesuchstellerDTO RecordBuilder
   */
  public static ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder newBuilder(ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO other) {
    if (other == null) {
      return new ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder();
    } else {
      return new ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GesuchstellerDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.vorname)) {
        this.vorname = data().deepCopy(fields()[0].schema(), other.vorname);
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder setVorname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder clearVorname() {
      vorname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder setNachname(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder clearNachname() {
      nachname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.dvbern.kibon.exchange.commons.verfuegung.GesuchstellerDTO.Builder clearEmail() {
      email = null;
